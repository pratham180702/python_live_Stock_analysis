...
if(choice1 == '1'):
    ...
    if(choice == '1'):
        ...
        plt.axhline(y=df['Support 1'].iloc[-1], color='r', linestyle='--',label = "1st Support = "+str(df['Support 1'].iloc[-1])[0:5]+" USD")
        ...
        plt.axhline(y=df['WS1'].iloc[-1], color='r', linestyle='--',label = "Woodie S1 = "+str(df['WS1'].iloc[-1])[0:5]+" USD")
